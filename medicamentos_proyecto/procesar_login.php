...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // 5. Buscamos al usuario en la tabla por su correo electrónico
    ...
    if ($resultado && $resultado->num_rows === 1) {
        ...
        if (password_verify($contrasenia_ingresada, $usuario['contrasenia'])) {
            ...
            // --- REDIRECCIÓN INTELIGENTE SEGÚN EL ROL DE LA BASE DE DATOS ---
            $rol = $usuario['rol'];
            ...
            if ($rol === 'Paciente') {
                ...
                $destino = 'menu_independiente.php'; // Por si tienen rol de Uso Personal
            }
