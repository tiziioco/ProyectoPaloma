...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // --- PASO B: GUARDAR LOS MEDICAMENTOS EN TU TABLA REAL ---
    if (isset($_POST['nombre_med']) && is_array($_POST['nombre_med'])) {
        ...
        for ($i = 0; $i < count($nombres); $i++) {
            ...
            if (!empty($nombre_comercial)) {
                // Calibrado exacto para tus campos de phpMyAdmin: nombre_comercial y fk_id_usuario
                $sql_med = "INSERT INTO medicamento (nombre_comercial, compuesto, presentacion, stock_actual, stock_minimo, fecha_vencimiento, fk_id_usuario) 
                            VALUES ('$nombre_comercial', 'No especificado', 'Pastilla', $stock_actual, 5, '2027-12-31', $id_paciente_actual)";
