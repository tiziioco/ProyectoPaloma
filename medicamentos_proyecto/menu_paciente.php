...
// --- MOTOR DE CÁLCULO DE PRÓXIMA TOMA ---
...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; font-family: 'Segoe UI', system-ui, sans-serif; }
        ...
        /* --- ESTILOS DEL CRONÓMETRO DIGITAL --- */
        .countdown-container-block {
            background: #090e1a; border: 2px solid var(--neon-blue); border-radius: 16px;
...
<body>
    ...
    <main>
                    ...
                    <div class="field-group" style="margin-bottom: 45px;">
                        ...
                        <div class="selector-grid">
                            <div class="selector-box" onclick="alternarDolor(this, 'espalda')">
                                ...
                                <span class="box-icon">12946;</span>
        ...
        <?php else: ?>
            ...
            <div class="dashboard-workspace">
                ...
                <!-- CONTADOR INDEPENDIENTE PREMIUM CELESTE NEÓN -->
                <div class="countdown-container-block">
                ...
                <!-- SECCIÓN DINÁMICA DE CONSEJOS ROTATIVOS DE SALUD Y VIDA -->
                ...
                <!-- NUEVA DISPOSICIÓN DE ELEMENTOS EN DOS COLUMNAS -->
                <div class="layout-workspace" style="display: grid; grid-template-columns: 1fr 1fr; gap: 30px; align-items: start;">
                    
                    <!-- COLUMNA IZQUIERDA: CUIDADOR Y ACCESO HORIZONTAL LARGO ABAJO -->
                    <div class="column-actions" style="display: flex; flex-direction: column; gap: 20px;">
                        
                        <!-- NUEVA OPCIÓN: CONTACTAR / SABER DEL CUIDADOR -->
                    ...
                    <!-- COLUMNA DERECHA: MEDICAMENTOS DISPONIBLES (ARRIBA) -->
                            ...
                            ?>
                                <div class="stock-row">
                                    ...
                                    <div class="stock-meta-wrapper">
                                        ...
                                        <!-- Muestra la hora real guardada en la base de datos sin errores -->
                                        <span class="pill-status status-valid">
                                            ⏰ TOMAR <?php echo (!empty($med['horario'])) ? date("H:i", strtotime($med['horario'])) : "00:00"; ?> HS
                                        </span>
                ...
                <!-- BOTÓN ADMINISTRAR BOTIQUÍN CONFIGURADO COMO BARRA ANCHA ABAJO DE TODO -->
    ...
    <script>
        ...
        // --- MOTOR DE CUENTA REGRESIVA CONECTADA AL HORARIO REAL DE LA BASE DE DATOS ---
        ...
        function actualizarCronometroBloques() {
            ...
            objetivo.setHours(parseInt(partesHora[0]), parseInt(partesHora[1]), parseInt(partesHora[2] || 0), 0);
        ...
        // --- MOTOR DE ROTACIÓN DE CONSEJOS DE SALUD Y VIDA ---
        ...
        // --- FUNCIONES DEL FORMULARIO ASISTENTE ---
