...
$sql_cuidadores = "SELECT id_usuario, nombre FROM usuario WHERE rol = 'Cuidador' AND id_superior = 1 ORDER BY nombre ASC";
    ...
    <main>
        ...
        <?php else: ?>
            ...
            <div class="dashboard-workspace">
                ...
                <!-- CRONÓMETRO DIGITAL CON LIENZO DE CASCADA DE CRUCES -->
